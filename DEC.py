...
def tsne(x, y, y_pred):
    ...
    if 1==1:
        ...
        embeddings = TSNE(n_components=2, init='pca', verbose=2).fit_transform(X_sample_flat)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='mnist',
                        choices=['mnist', 'fmnist', 'usps', 'reuters10k', 'stl', 'egocentric', 'egofull'])
    ...
    if args.dataset == 'mnist' or args.dataset == 'fmnist':
        ...
        update_interval = 30
        pretrain_epochs = 10
    elif args.dataset == 'egocentric' or args.dataset == 'egofull':
        update_interval = 30
        pretrain_epochs = 50
